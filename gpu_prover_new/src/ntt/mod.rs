...
strided_tiles_stages!(ab_main_to_monomials_first_9_stages_kernel);
strided_tiles_stages!(ab_main_to_monomials_first_10_stages_kernel);
...
pub fn main_to_monomials_2_pass(
    ...
    for col in 0..num_ntts {
        ...
        let function = match log_n {
            23 => StridedTilesStagesFunction(ab_main_to_monomials_first_9_stages_kernel),
            24 => StridedTilesStagesFunction(ab_main_to_monomials_first_10_stages_kernel),
            _ => unimplemented!(),
        };
