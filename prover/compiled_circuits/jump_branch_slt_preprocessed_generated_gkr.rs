    ...
    W::I32: Copy,
{
    ...
    let v_8 = witness_proxy.get_memory_place_u16(3usize);
    ...
    let mut v_25 = v_13;
    W::U32::add_assign(&mut v_25, &v_23);
    let v_26 = WitnessComputationCore::select(&v_9, &v_25, &v_15);
    let v_27 = WitnessComputationCore::select(&v_4, &v_25, &v_26);
    let v_28 = WitnessComputationCore::select(&v_5, &v_24, &v_27);
    let v_29 = WitnessComputationCore::select(&v_6, &v_15, &v_28);
    let v_30 = v_29.shr(16u32);
    let v_31 = v_30.truncate();
    let v_33 = v_29.truncate();
    witness_proxy.set_witness_place_u16(10usize, v_33);
    let v_35 = W::U16::constant(4u16);
    let v_36 = W::U16::overflowing_add(&v_0, &v_35).1;
    let v_37 = W::U16::overflowing_add(&v_7, &v_2).1;
    let v_38 = W::U16::overflowing_add(&v_0, &v_2).1;
    let v_39 = W::U32::overflowing_add(&v_13, &v_14).1;
    let v_40 = W::Mask::select(&v_9, &v_38, &v_39);
    let v_41 = W::Mask::select(&v_4, &v_38, &v_40);
    let v_42 = W::Mask::select(&v_5, &v_37, &v_41);
    let v_43 = W::Mask::select(&v_6, &v_36, &v_42);
    witness_proxy.set_witness_place_boolean(13usize, v_43);
    let v_45 = W::U32::overflowing_add(&v_19, &v_23).1;
    let v_46 = W::U32::overflowing_add(&v_13, &v_23).1;
    let v_47 = W::Mask::select(&v_9, &v_46, &v_36);
    let v_48 = W::Mask::select(&v_4, &v_46, &v_47);
    let v_49 = W::Mask::select(&v_5, &v_45, &v_48);
    let v_50 = W::Mask::select(&v_6, &v_39, &v_49);
    ...
    W::I32: Copy,
{
    ...
    let v_3 = v_2[1usize];
    let v_5 = v_2[0usize];
    witness_proxy.set_witness_place(18usize, v_5);
}
#[allow(unused_variables)]
