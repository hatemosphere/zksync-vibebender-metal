...
pub struct DelegationTraceDevice {
    ...
    pub write_timestamp: MetalBuffer<TimestampData>,
    pub register_accesses: MetalBuffer<RegisterOrIndirectReadWriteData>,
    pub indirect_reads: MetalBuffer<RegisterOrIndirectReadData>,
    pub indirect_writes: MetalBuffer<RegisterOrIndirectReadWriteData>,
}
